...
<body>
  <table>
    <tr>
      <td align="center">
          <img style="margin-left: 75px;width:715px; height: auto;" src="{{ asset('img/STTNASKUITANSI.png') }}" align="center" alt="">
      </td>
    </tr>
    <tr>
      <td style="vertical-align:bottom;text-align:right;">
        <span style="font-size:10px;"><?php echo date("d m Y"); ?></span>
      </td>
    </tr>
  </table>
  <hr>
  ...
  <table style="width:100%;">
      ...
      <tr class="<?php echo $class1 ?>">
        ...
        <td align="right" class="td"><?php echo number_format($sum,'0',',','.') ?></td>
      </tr>
