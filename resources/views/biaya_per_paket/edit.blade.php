    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ asset('/biaya_per_paket?Term_Year_Id='.$data->Term_Year_Id.'&Department_Id='.$data->Department_Id.'&Class_Prog_Id='.$data->Class_Prog_Id)}}" class="btn btn-danger btn-sm">Batal &nbsp;<i class="fa fa-close"></i></a>
        </div>
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
        <?php
         ...
         ?>
        <form class="form-horizontal" method="POST" action="{{ asset('biaya_per_paket/edit_post/'.$data->Course_Cost_Package_Id)}}">
          {{ csrf_field() }}
          <input type="hidden" name="Course_Cost_Package_Id" value="<?php echo $data->Course_Cost_Package_Id ?>" required>
          ...
          <div class="form-group">
              ...
              <div class="col-md-12">
                      <input id="" type="text" class="form-control form-control-sm" name="" value="<?php echo $data->Department_Name ?>" readonly>
              </div>
          </div>
            <div class="form-group">
                <label for="email" class="col-md-4 control-label">Biaya</label>
                <div class="col-md-12">
                    <input id="" type="number" class="form-control form-control-sm" name="Amount_Per_Mk" value="<?php echo $data->Amount_Per_Mk ?>" required>
                </div>
            </div>
