    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ asset('/biaya_per_paket?Term_Year_Id='.$Term_Year_Id.'&Department_Id='.$Department_Id.'&Class_Prog_Id='.$Class_Prog_Id)}}" class="btn btn-danger btn-sm">Batal &nbsp;<i class="fa fa-close"></i></a>
        </div>
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
        ...
        <form class="form-horizontal" method="POST" action="create_post">
          {{ csrf_field() }}
              ...
              <div class="col-md-12">
                ...
                if ($Department_Id != null) {
                  ...
                  <select class="form-control form-control-sm" name="Department_Id" required>
                    ...
                    foreach ($q_Department as $data_Department) {
                      ?>
                      <option value="<?php echo $data_Department->Department_Id ?>"><?php echo $data_Department->Department_Name ?></option>
                      <?php
                    }
                    ?>
                  </select>
            ...
            <div class="form-group">
                <label for="email" class="col-md-4 control-label">Mata Kuliah</label>
                <div class="col-md-12">
                  <?php
                    if ($Course_Cost_Type_Id != null) {
                      foreach ($q_FCCT as $data_FCCT) {
                        ?>
                        <input id="" type="text" class="form-control form-control-sm" name="" value="<?php echo $data_FCCT->Course_Name ?>" readonly>
                        <input type="hidden" name="Course_Cost_Type_Id" value="<?php echo $data_FCCT->Course_Cost_Type_Id ?>" required>
                        <?php
                      }
                    }else{
                      ?>
                      <select class="form-control form-control-sm" name="Course_Cost_Type_Id" required>
                        <option value="">-- Pilih Mata Kuliah --</option>
                        <?php
                          foreach ($q_FCCT as $data_FCCT) {
                            ?>
                            <option value="<?php echo $data_FCCT->Course_Cost_Type_Id ?>"><?php echo $data_FCCT->Course_Name ?></option>
                            <?php
                          }
                         ?>
                      </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input id="" type="number" class="form-control form-control-sm" name="Amount_Per_Mk" value="" required>
                </div>
            </div>
            <div class="form-group">
