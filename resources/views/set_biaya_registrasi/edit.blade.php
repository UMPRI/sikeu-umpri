    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ asset('/set_biaya_registrasi?Term_Year_Id='.$fnc_cost_sched->Term_Year_Id.'&Entry_Year_Id='.$fnc_cost_sched->Entry_Year_Id.'&Entry_Period_Type_Id='.$fnc_cost_sched->Entry_Period_Type_Id)}}" class="btn btn-danger btn-sm">Batal &nbsp;<i class="fa fa-close"></i></a>
        </div>
                  ...
                  <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content" style="background-color:white;padding:10px;color:#333;">
                    <div class="form-horizontal">
                      <form class="form-horizontal" method="POST" action="edit_post">
                        {{ csrf_field() }}
                        <input type="hidden" name="Cost_Sched_Id" id="Cost_Sched_Id" value="<?php echo $fnc_cost_sched->Cost_Sched_Id ?>">
                          <div class="form-group">
                              <label class = "control-label col-md-4">Th Akademik</label>
                              <div class="col-md-12">
                                  <input type="text" value="<?php echo $fnc_cost_sched->Term_Year_Name ?>" disabled class="form-control form-control-sm">
                                  <input type="Hidden" value="<?php echo $fnc_cost_sched->Term_Year_Id ?>" name="Term_Year_Id" id="Term_Year_Id" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-12">
                                  <input type="text" value="<?php echo $fnc_cost_sched->Entry_Year_Id ?>" disabled class="form-control form-control-sm">
                                  <input type="Hidden" value="<?php echo $fnc_cost_sched->Entry_Year_Id ?>" name="Entry_Year_Id" id="Entry_Year_Id" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-12">
                                  <input type="text" value="<?php echo $fnc_cost_sched->Entry_Period_Type_Name ?>" disabled class="form-control form-control-sm">
                                  <input type="Hidden" value="<?php echo $fnc_cost_sched->Entry_Period_Type_Id ?>" name="Entry_Period_Type_Id" id="Entry_Period_Type_Id" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-12">
                                  <input type="text" value="<?php echo $fnc_cost_sched->Department_Name." ".$fnc_cost_sched->Acronym  ?>" disabled class="form-control form-control-sm">
                                  <input type="hidden" name="Department_Id" id="Department_Id" value="<?php echo $fnc_cost_sched->Department_Id ?>" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-12">
                                  <input type="text" value="<?php echo $fnc_cost_sched->Class_Program_Name ?>" disabled class="form-control form-control-sm">
                                  <input type="hidden" name="Class_Prog_Id" id="Class_Prog_Id" value="<?php echo $fnc_cost_sched->Class_Prog_Id ?>" required>
                              </div>
                          </div>
                          <div class="row">
                              ...
                              <label for="Nama" class = "control-label col-md-4">Mulai</Label>
                                <div class="col-md-12 col-sm-12">
                                  <div class="input-group date">
                                    <?php
                                    $Start_Date = Date('Y/m/d',strtotime($fnc_cost_sched->Start_Date));
                                    ?>
                              ...
                              <div class="form-group panggil_date">
                                <label for="Nama" class = "control-label col-md-4">Selesai</Label>
                                  <div class="col-md-12 col-sm-12">
                                    <div class="input-group date">
                                      <?php
                                      $End_Date = Date('Y/m/d',strtotime($fnc_cost_sched->End_Date));
                                      ?>
                  ...
                  <div class="col-md-6">
                    <div class="panel panel-default panel-green" >
                        <div class="panel-heading" style="padding:10px 20px;">
                          ...
                          <input type="hidden" id="url" name="url" value="{{asset('set_biaya_registrasi/edit_post/'.$fnc_cost_sched->Cost_Sched_Id)}}">
                          <input type="hidden" id="href" name="href" value="{{asset('set_biaya_registrasi?Term_Year_Id='.$fnc_cost_sched->Term_Year_Id.'&Entry_Year_Id='.$fnc_cost_sched->Entry_Year_Id.'&Entry_Period_Type_Id='.$fnc_cost_sched->Entry_Period_Type_Id)}}">
    ...
    $(document).ready(function () {
      ...
      $("#End_Date").kendoDatePicker({
        ...
        $(document).ready(function () {
          ...
          var array = <?php echo json_encode($fnc_cost_sched_details); ?>;
                ...
                if (isAllValid) {
                    ...
                    $.ajax({
                      headers: {
                        ...
                        data : {
                            Cost_Sched_Id: parseInt($('#Cost_Sched_Id').val().trim()),
                            Entry_Year_Id: parseInt($('#Entry_Year_Id').val().trim()),
                            Entry_Period_Type_Id: parseInt($('#Entry_Period_Type_Id').val().trim()),
                            Payment_Order: parseInt($('#Payment_Order').val().trim()),
                            Department_Id: parseInt($('#Department_Id').val().trim()),
                        ...
                        type: "POST",
                        url: "{{ url('set_biaya_registrasi/edit/'.$fnc_cost_sched->Cost_Sched_Id) }}",
                        success: function (d) {
