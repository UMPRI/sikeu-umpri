        ...
        <form class="form-horizontal" method="POST" action="create_post">
          {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                  <textarea name="Description" class="form-control form-control-sm" rows="3" cols="10" required oninvalid="this.setCustomValidity('Keterangan tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class="input-group">
                    <input id="" type="Number" min="0" max="100" class="form-control form-control-sm" name="Percent" value="" required oninvalid="this.setCustomValidity('Diskon tidak boleh kosong')" oninput="setCustomValidity('')">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-sm" name="Course_Type_id">
                      ...
                      @foreach ($q_Acd_Course_Type as $ACT)
                        <option value="{{ $ACT->Course_Type_Id }}">{{ $ACT->Course_Type_Name }}</option>
                      @endforeach
                    </select>
                </div>
            </div>
