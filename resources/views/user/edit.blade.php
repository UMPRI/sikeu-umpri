  ...
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
        ...
        <!-- {!! Form::label('', 'Password', ['class' => 'col-md-4 col-xs-12']) !!}
        <input type="password" name="password" min="1" value="" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" class="form-control">
        {!! Form::label('', 'Confirm Password', ['class' => 'col-md-4 col-xs-12']) !!}
        <input type="password" name="confirm" min="1" value="" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" class="form-control"> -->
        <div class="form-group">
