    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ asset('/set_biaya_registrasi_personal/edit/'.$Cost_Sched_Personal_Id)}}" class="btn btn-danger btn-sm" style="font-size:medium">Kembali <i class="fa fa-reply"></i></a>
        </div>
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
          <div class="row">
              <div class="col-md-12">
                  <form class="form-horizontal" method="POST" action="{{ asset('/set_biaya_registrasi_personal_detail/edit_post/'.$Cost_Sched_Personal_Detail_Id)}}">
                    {{ csrf_field() }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3">
                              <input type="hidden" name="url" id="url" value="{{ asset('set_biaya_registrasi_personal_detail/edit/'.$Cost_Sched_Personal_Detail_Id.'?Cost_Item_Id=')}}">
                              <select class="form-control form-control-sm" name="Cost_Item_Id" onchange="SelectionChanged()" id="Cost_Item_Id" required>
                        ...
                        <div class="form-group panggil_date">
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="input-group date">
                                  <input type="number" name="Normal_Amount" value="<?php echo $Normal_Amount ?>" min="0" readonly class="form-control form-control-sm">
                                </div>
                            </div>
                        </div>
                        <?php
                      ...
                      <div class="form-group panggil_date">
                          ...
                          <div class="col-md-5 col-sm-5">
                              <div class="input-group date">
                                <input type="number" name="Amount" value="<?php echo $Amount ?>" min="0" required class="form-control form-control-sm">
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group panggil_date">
                          ...
                          <div class="col-md-2 col-sm-2">
                              <div class="input-group date">
                                <input type="number" name="Percentage" value="<?php echo $fnc_cost_sched_personal_detail->Percentage ?>" min="0" max="100" class="form-control form-control-sm">
